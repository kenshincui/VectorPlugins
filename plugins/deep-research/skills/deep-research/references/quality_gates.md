...
|---------|----------------|-----|
| URL not from an actual worker or sequential retrieval result | P7 registry check | Remove citation |
...
| Worker invented a URL | Gate 1 (coordinator verifies task notes) | Remove from notes before P3 |
