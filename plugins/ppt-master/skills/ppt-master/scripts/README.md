...
| Animation resources | project-local licensed audio; `sound_sync.py` retained for upstream compatibility but bundled WAVs are omitted | [sound distribution notes](../templates/sounds/README.md); [docs/pptx-animations.md](./docs/pptx-animations.md) |
